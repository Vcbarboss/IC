...
public class api2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				if (arqs.contains(coluna[0])) {
					...
					if (!(coluna[3].equals("TRUE") || coluna[3].equals("EMPTY LINE")
								...
								if (!(arqAuth.contains(coluna[5]))) {
									...
									try {
										...
										while ((lin = tr.readLine()) != null) {
											...
											if (!(col[3].equals("NULL") || col[3].equals("EMPTY LINE"))) {

												if (col[0].equals(arqs.get(i)) && col[5].equals(coluna[5])) {
									...
									try {
										...
										while ((lin = tr.readLine()) != null) {
											...
											if (!(col[3].contains("NULL") || col[3].contains("EMPTY LINE"))) {
												...
												if (col[0].equals(arqs.get(i)) && col[4].equals(coluna[4])) {
									...
									try {
										...
										while ((lin = tr.readLine()) != null) {
											...
											if (!(col[3].equals("NULL") || col[3].equals("EMPTY LINE"))) {
												...
												if (col[0].equals(arqs.get(i)) && col[3].equals(coluna[3])) {
			...
			String resultado = "{ \""+ repo[0] +"\" : {" + arqFinal + "}}";

			try (FileWriter writer = new FileWriter("C:\\Users\\Vini\\Desktop\\JSONS\\"+ repo[0] + "2parte1.txt");
					BufferedWriter bw = new BufferedWriter(writer)) {
		...
		String resultado = "{ \""+ repo[0] +"\" : {" + arqFinal + "," + commiFinal + "}}";

		try (FileWriter writer = new FileWriter("C:\\Users\\Vini\\Desktop\\JSONS\\"+ repo[0] + "2.txt");
				BufferedWriter bw = new BufferedWriter(writer)) {
