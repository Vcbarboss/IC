...
public class Repo {
	...
	public Repo(String repoURI) {
		...
		this.localPath = new File("C:" + System.getProperty("file.separator") + "repo" + System.getProperty("file.separator") + name);
	...
	private void createCommitsHistory() {
        ...
        for (RevCommit rev : walk){
        	Commit tempCommit = new Commit(rev.name(), rev.getAuthorIdent().getName(),rev.getAuthorIdent().getEmailAddress(), rev.getCommitterIdent().getName(), rev.getCommitterIdent().getEmailAddress(), rev.getCommitterIdent().getWhen());
