...
public class Estatisticas {
	...
	public static void main(String[] args) {
		...
		String metPath = "C:\\Users\\Vini\\Desktop\\Medidas"+ name +".csv";
		...
		med += "arquivos;" + nulo + ";" + menor + " (" + nome.get(posmenor) + ") ;" + maior + " ("
				+ nome.get(posmaior) + ") ;" + Medidas.calcularModa(valoresum) + ";"
		...
		med += menor + " (" + nome.get(posmenor) + ") ;" + maior + " (" + nome.get(posmaior) + ") ;"
		...
		med += " (" + nome.get(posmenor) + ") ;";
		med += maior + " ("	+ nome.get(posmaior) + ") ;";
